...
public:
	...
	static texture_id_t create(const std::string &path, std::uint32_t &w, std::uint32_t &h);
	static texture_id_t create(const uint8_t *data, size_t size, std::uint32_t &w, std::uint32_t &h);
